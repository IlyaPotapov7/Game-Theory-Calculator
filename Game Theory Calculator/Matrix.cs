...
public class GameTheoryMatrix : Model
{
    ...
    private Stack<GameTheoryMatrix> versionsStack;
    ...
    public GameTheoryMatrix(int Rows, int Cols, string[,] Payoffs, string[] RowStrategies, string[] ColStrategies, string Name, Stack<GameTheoryMatrix> VersionsStack, string[] Players, float X, float Y, RectangleF Hitbox)
    {
        rows = Rows;
        cols = Cols;
        payoffs = Payoffs;
    ...
    public Stack<GameTheoryMatrix> GetVersionStack()
    {
        return versionsStack;
    }

    public void SetVersionStack(Stack<GameTheoryMatrix> Stack)
    {
        versionsStack = Stack;
    }

    public void PushVersionStack(GameTheoryMatrix pushedMatrix)
    {
        versionsStack.Push(pushedMatrix);
    }

    public GameTheoryMatrix PopVersionStack()
    {
    ...
    public float DetermineCellWidth(Graphics g, GameTheoryMatrix matrix, Font text_font, Font payoff_font)
    {
    ...
    public float LongestCol(GameTheoryMatrix matrix, Graphics g, Font text_font, Font payoff_font)
    {
        float maxWidth = 0;
    ...
    public void ConvertPayoffsToFloat(GameTheoryMatrix matrix, float[,] Player1Payoffs, float[,] Player2Payoffs, List<string> NashEqualibria)
    {
    ...
    public void CalculateMatrixBounds(GameTheoryMatrix matrix, Graphics g, Font text_font, Font payoff_font)
    {
    ...
    public GameTheoryMatrix defaultMatrix(List<GameTheoryMatrix> savedMatricies, int count)
    {
        ...
        foreach (GameTheoryMatrix matrix in savedMatricies)
        {
        ...
        Stack<GameTheoryMatrix> defaultStack = new Stack<GameTheoryMatrix>();
        RectangleF defaultRectangle = new RectangleF();
        GameTheoryMatrix defaultMatrix = new GameTheoryMatrix(2, 2, defaultPayoffs, defaultRowStrategies, defaultColStrategies, defaultName, defaultStack, defaultPlayers, 150, 80, defaultRectangle);
